...
program
  ...
  .option('-sh --sharpness <n>', 'Set image sharpness (-100 - 100)', parseInt)
  .option('-co --contrast <n>', 'Set image contrast (-100 - 100)', parseInt)
  .option('-br --brightness <n>', 'Set image brightness (0 - 100) 0 is black, 100 is white', parseInt)
  .option('-sa --saturation <n>', 'Set image saturation (-100 - 100)', parseInt)
